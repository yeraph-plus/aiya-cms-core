...
namespace Aiya\Infra\Typesetting;
...
{
    /**
     * 可用的纠正方法名（correct() 的方法白名单）.
     *
     * @var list<string>
     */
    public const METHODS = [
        'insertSpace', 'removeSpace', 'full2Half', 'fixPunctuation', 'properNoun',
        'removeClass', 'removeId', 'removeStyle', 'removeEmptyParagraph',
        'removeEmptyTag', 'removeIndent',
    ];
    ...
    {
        $dict = include __DIR__.'/Resources/proper-nouns.php';
        if (!empty($extend)) {
