...
/**
 * File-name to icon-category mapping, ported from the legacy attachment
 * panel (the same extension buckets). Icons themselves are front-end
 * concerns; the contract only carries the category string.
 */
final class FileIcons
{
    ...
    /**
     * The icon category for one entry; directories are always 'folder' and
     * unknown extensions collapse to 'unknown' (or 'document' when icons
     * are disabled in the settings, matching the legacy panel).
     */
